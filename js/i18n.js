...
window.I18N = {
  ...
  'zh-CN': {
    ...
    's1.sub': '用自然语言向数据提问，不写 SQL、不等排期，快速完成数据分析',
    's1.c1.title': '智能问答',
    's1.c1.desc': '向数据提问，秒级生成图表答案',
    's1.c2.title': 'AI 搭建报表',
    's1.c2.desc': '描述需求，AI 辅助生成图表与仪表板',
    's1.c3.title': '智能洞察',
    's1.c3.desc': '自动发现数据波动与异常原因',
    's1.shots.note': '产品界面截图 · 待提供（≥1200px，内容脱敏）',
    ...
    's3.d1.theme': '新手入门：认识 AIPro，搭建你的第一个仪表板',
    's3.d1.out': '一个可分享的数据仪表板',
    's3.d2.theme': '掌握常见的表格组件',
    's3.d2.out': '明细表 / 交叉表报表',
    's3.d3.theme': '掌握常见的图表组件',
    's3.d3.out': '多图表组合的分析看板',
    's3.d4.theme': '掌握数据加工与基础函数使用',
    's3.d4.out': '带计算字段的数据集',
    's3.d5.theme': '通过一个综合案例融会贯通',
    's3.d5.out': '一份完整的行业分析案例',
    's3.duration': '约 40 分钟',
    ...
    's5.final.t1.name': '阿里云拍拍灯 + 数据分析师课程名额',
    's5.final.t1.value': '价值 ¥2,400',
    ...
    's5.cert.name': '证书名称待定（往期：《Quick BI 初级开发者认证》）',
    's5.compliance': '* 奖品以当期实际发放为准；奖品与证书图片为占位，待运营提供',
    's5.imgNote': '占位图 · 待提供',
    ...
    's7.q4': '没有产品账号怎么办？',
    's7.a4': '已购买产品的客户使用正式账号即可；暂无账号可点击申请免费试用。',
    's7.q5': '学习中遇到问题怎么办？',
  ...
  'en-US': {
    ...
    's1.sub': 'Ask your data questions in natural language — no SQL, no waiting, instant analysis',
    's1.c1.title': 'Intelligent Q&A',
    's1.c1.desc': 'Question your data and get chart answers in seconds',
    's1.c2.title': 'AI-Built Reports',
    's1.c2.desc': 'Describe your needs and let AI generate charts and dashboards',
    's1.c3.title': 'Smart Insights',
    's1.c3.desc': 'Automatically surface data fluctuations and root causes',
    's1.shots.note': 'Product screenshots · To be provided (≥1200px, desensitized)',
    ...
    's3.d1.theme': 'Getting started: meet AIPro and build your first dashboard',
    's3.d1.out': 'A shareable data dashboard',
    's3.d2.theme': 'Master common table components',
    's3.d2.out': 'Detail / pivot tables',
    's3.d3.theme': 'Master common chart components',
    's3.d3.out': 'A multi-chart analysis board',
    's3.d4.theme': 'Master data processing and basic functions',
    's3.d4.out': 'A dataset with calculated fields',
    's3.d5.theme': 'Put it all together with a real case',
    's3.d5.out': 'A complete industry analysis case',
    's3.duration': '~40 min',
    ...
    's4.p1.desc': 'New to BI / AIPro and want a structured path instead of scattered docs',
    ...
    's4.gain.1': 'The ability to build dashboards on your own',
    ...
    's5.final.t1.name': 'Alibaba Cloud tap light + data analyst course seat',
    's5.final.t1.value': 'Worth ¥2,400',
    ...
    's5.cert.name': 'Certificate name TBC (previous: Quick BI Certified Beginner Developer)',
    's5.compliance': '* Prizes subject to actual availability; prize and certificate images are placeholders pending operations',
    's5.imgNote': 'Placeholder · To be provided',
    ...
    's7.a4': "Existing customers can use their official accounts. If you don't have one, you can apply for a free trial.",
    ...
    's8.contact.note': 'QR code · To be provided',
